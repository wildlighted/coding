...
def formcount(list): # функция подсчитывает количество форм на -ed и -ied в разделенном на "слова" тексте, возвращает список из этих двух значений в соответствующем порядке
    count_ed = 0
    count_ied = 0
    for element in list:
